...
while(True):
	...
	if (cmd == 'load_yes'):
		...
		midi_beats = midiConversion.convert_beat_to_midi(notes, UI_beat_pattern, UI_time_signature, UI_instrument_beats, reg_notes)
		...
		# PREVIEW
		utils.preview(filename=settings['filename'],length=0.25)
